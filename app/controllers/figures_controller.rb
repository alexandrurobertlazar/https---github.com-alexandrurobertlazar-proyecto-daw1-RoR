class FiguresController < ApplicationController
  ...
  private
    ...
    def figure_params
      params.require(:figure).permit(:name, :category, :subcategory, :picture, :price, :oldPrice, :description, :attributes, :quality, :company, :delivery, :delivery_time, :stock, :bestseller)
    end
end
